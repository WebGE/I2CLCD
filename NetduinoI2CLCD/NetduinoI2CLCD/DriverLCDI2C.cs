...
namespace I2CLCD
{
    class I2CLcd
    {
        ...
        private UInt16 i2c_Add_7bits = 0x3A;
        ...
        public I2CLcd(UInt16 I2C_Add_7bits)
        {
        ...
        {
            this.i2c_Add_7bits = (UInt16)ManufacturerName;
            ConfigI2CLcd = new I2CDevice.Configuration(i2c_Add_7bits, 100);
        }
        ...
        /// </summary>
        /// <param name="I2C_Add_7bits">Manufacturer Adress I2C</param>
        /// <param name="Frequency">Bus frequency</param>
        public I2CLcd(UInt16 I2C_Add_7bits, UInt16 Frequency)
        {
            this.i2c_Add_7bits = I2C_Add_7bits;
            ConfigI2CLcd = new I2CDevice.Configuration(i2c_Add_7bits, Frequency = 100);
        }
        ...
        ///<param name="ManufacturerName">LCD Manufacturer Name</param>
        /// <param name="Frequency">Bus frequency</param>
        public I2CLcd(LcdManufacturer ManufacturerName, UInt16 Frequency = 100)
        {
            this.i2c_Add_7bits = (UInt16)ManufacturerName;
            ConfigI2CLcd = new I2CDevice.Configuration(i2c_Add_7bits, Frequency);
        }
        ...
        public void Init()
        {
            ...
            if (i2c_Add_7bits == (UInt16)LcdManufacturer.BATRON)
            {
        ...
        public void SetBacklight(byte bright)
        {
            ...
            if (i2c_Add_7bits == (UInt16)LcdManufacturer.MIDAS)
            {
                if (bright > 20)
                {
                    bright = 20;
            ...
            else if (i2c_Add_7bits == (UInt16)LcdManufacturer.BATRON)
            { 
                if (bright > 20)
                {
                    bright = 20;
